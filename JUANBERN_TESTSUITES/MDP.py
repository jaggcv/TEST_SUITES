"""
Given a floating point x, this benchmark runs a simulation
of a battle with damages and topological sorting of nodes in a graph.
...
@misc{python-pyperformance,
  ...
  url = {https://github.com/python/pyperformance/blob/main/pyperformance/data-files/benchmarks/bm_go}
}
"""
import collections
...
def aBench_mdp(tolerance):
    ...
    for _ in range_it:
        result = Battle().evaluate(tolerance)
