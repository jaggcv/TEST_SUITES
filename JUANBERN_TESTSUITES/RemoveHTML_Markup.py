...
if __name__ == "__main__":
    print(remove_html_markup("abc"))

    print(remove_html_markup("<b>abc</b>"))

    print(remove_html_markup('"""abc"""'))

    print(remove_html_markup('"<i class=""gfg-icon gfg-icon_dark-mode"">HOLA</i></button>"'))

    print(remove_html_markup('<p><strong># Example 2:</strong>'))

    print(remove_html_markup('<button data-gfg-action=article-difficulty data-rating=3 class=btn>Medium</button>'))